...
#define limiteContadorAuto 8 // quantas peças bater antes de travar automatico
...
volatile unsigned int intSensor, intSensorOff = 0; //This variable will increase or decrease depending on the rotation of encoder
...
void setup() {
  ...
  //B rising pulse from encodenren activated ai1(). AttachInterrupt 1 is DigitalPin nr 2 on moust Arduino.
  attachInterrupt(1, ai0RISING, RISING);
  //encoder-fim
